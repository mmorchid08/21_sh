...
EXECUTION_FILES = builtins.c  data_from_env.c echo_command.c env.c error.c exexc.c free.c main.c pipe_semi.c prepar_to_exe.c redirection.c setenv_command.c ft_builtin_cd.c ft_builtin_cd_2.c ft_path.c ft_path2.c error2.c exexc2.c pipe_semi2.c main2.c redirection2.c main3.c
