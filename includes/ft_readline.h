...
/*   Updated: 2020/03/11 16:47:04 by youarzaz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					ft_exec_echo(t_line *line);
void					ft_exec_unsetenv(t_line *line);
void					ft_exec_setenv(t_line *line);
void					ft_exec_unalias(t_line *line);
void					ft_exec_alias(t_line *line);
void					ft_exec_env(t_line *line);
int						ft_unsetenv_var(t_var **var, char *key);
void					ft_exec_cd(t_line *line);
...
int						ft_exec_none_builtin(t_line *line);
...
void					ft_exec_pipe(t_line *line, int pipecount);
